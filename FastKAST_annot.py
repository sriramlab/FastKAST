...
def paraCompute(args):
    ...
    if len(gammas) == 1:
        ...
        # print(f'pval is {pval}')
        return (pval, p_perm, FastKAST_times, start_index, end_index, N, d,
                bgamma, states, count)
    elif HP == 'CCT':
        ...
        return ((pval_cct, pval_mcm, pval_cmc), None, FastKAST_times,
                start_index, end_index, N, d, None, pvals, states)
    else:
