...
def common_options(f):
    f = click.option('--bfile', required=True,
                     help='Plink bfile base name. Required.')(f)
    f = click.option('--covar', required=False,
                     help='Covariate file. Not required')(f)
    f = click.option('--phen', required=True,
                     help='Phenotype file. Required')(f)
    f = click.option('--thread', default=1, type=int,
                     help='Default run on only one thread')(f)
    ...
    f = click.option('--output', default='sim_results',
                     help='Prefix for output files.')(f)
    f = click.option('--annot', default=None,
                     help='Provided annotation file')(f)
...
@click.option('--test', default='nonlinear',
              type=click.Choice(
                  ['linear', 'nonlinear', 'general', 'QuadOnly']),
              help='What type of kernel to test')
def quad(**kwargs):
